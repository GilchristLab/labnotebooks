...
\labday{June 16, 2016}
    \begin{itemize}
        ...
        \begin{itemize}
          ...
          \item All codons for L in the mutation traces stop changing and fall out around sample 100 shown in Figure 1.
          \item R falls out around sample 300 also shown in Figure 1.
          \item It's the same story for both L and R in the selection traces except it takes about half as many samples for both to fall out as shown in Figure 2.
        \end{itemize}
        \item Run 2
        \begin{itemize}
