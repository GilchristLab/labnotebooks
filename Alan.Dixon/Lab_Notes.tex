...
\footnote{mikeg: 06/24/16 -- 
  ...
  \end{itemize}
        ...
        \begin{itemize}
            \item Log Likelihood values plummet once again. At the end of the MCMC loop the value had reached -1.8e-40. See Figure 7.\footnote{mikeg: 06/24/16 -- You should use the \textforwardslash label\{\} and \textforwardslash ref\{\} commands rather than labeling and referring to figures using hard coded numbers.}
