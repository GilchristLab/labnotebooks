...
The probability of elongation is extensive and resource intensive. Dr. Gilchrist has provided me with ways of calculating this function in a series. The notebook can be found in the reading directort. Need to look into run time complexity of arg function to determine if it is a better implementation than the continued fractions which is in place.
\end{document}
