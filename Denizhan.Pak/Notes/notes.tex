...
After git issue some scripts got deleted rerwrote as needed so as to have two available datasets to run MCMC on. Will check up on Gauley later tonight and in the morning. A
