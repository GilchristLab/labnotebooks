...
\experiment{Time Breakdown}
\begin{itemize}
 \item 11 - 1: Testing the way simulated Genes are stored
 \item 2 - 3: Adding positional information to code for reading and writing simulations
...
\experiment{Time Breakdown}
\begin{itemize}
 \item 12 - 2: Fixing RFP count storage in data
