...
\begin{itemize}
    ...
    \item Idea: Get median of Alpha and Lambda and use each as a good estiamte of Alpha and Lambda values. Then we can use these to calculate expected waiting times as per rfp.model.pdf.
...
\begin{itemize}
    ...
    \item Motivation for oding this is to get one step closer to having simulation re-fixed for Denizhan to then be able to modify for PANSE and then let him be busy writing that function.
\end{itemize}
