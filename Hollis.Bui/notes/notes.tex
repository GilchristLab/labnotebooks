...
\experiment{RFP Structure}
\begin{itemize}
    \item Renamed a helper function (testEqualityGenome) to testGenomeSimulatedPAEqualityHelper. I think that while this name is long, it's descriptive (and only used in unit testing anyway); I think we will also need a variant of this function when we test equality of PANSE, anyway.
\end{itemize}
