...
\begin{itemize}
    ...
    \item Will re-format the processed code, perhpas run Mathematica to extract more relevant data with Dr. Gilchrist's original code (which I have in pdf format)
\end{itemize}
