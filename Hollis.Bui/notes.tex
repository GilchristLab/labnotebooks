...
\begin{itemize}
    ...
    \item Given Alpha, Lambda Prime, Phi, and a fasta file (presumably), use simulateGenome to creat a file that writes this simulated data to a .csv file or whatever.
    \item Really should rename RFP model by now to RFPROC -- rename RFPModel::simulateGenome() to RFPROCModel::simulateRFPROCModel() etc.
