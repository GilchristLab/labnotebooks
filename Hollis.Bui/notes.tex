...
% was used as a bandage on an abundance of overful hboxes. Will fix these case-by-case later.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Test MCMC - STALLED: Need run, vary\-Initial\-Conditions, calculate\-Geweke\-Score, get\-Log\-Likelihood\-Posterior\-Mean, and set\-Restart\-File\-Settings as well as two test that only functions.
        \begin{itemize}
...
Asked Cedric about get\-Selection\-Category and get\-Synthesis\-Rate\-Category (paraphrased):
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item model::propose\-Hyper\-Parameters -- parameter::propose\-Std\-Dev\-Synthesis\-Rate
...
I changed the deprecated Rcpp::loadRcppModules() function
to several Rcpp::loadModule() functions, 
...
\begin{itemize}
    ...
    \item Accuracy— within 80-90\% close estimates. Look at Laraeu data or Wineberg
...
\begin{itemize}
    ...
    go line-by-line and execute. The problem seems to be with "plot(model, genome, parameter, samples = samples*0.1, mixture = mixture, main = "Codon Usage Plot")".
\end{itemize}
