...
\begin{itemize}
    ...
    \item Doing so and checking Travis again reveals that somehow, the Log likelihood returns NaN at iteration 10. Full log output is below.
    \item Suspect this is one of the long-standing errors that the team as a whole has sporadically witnessed before. May be the biggest thing to prioritize.
    ...
    \begin{itemize}
        ...
        \item The formats are Name, Length, Sum-mRNA, Sum-FP, FP versus ORF, RFP\_Counts, Codon\_Counts, Codon -- ORF == Name, but rest are unknown.
