...
again to re-generate proper documentation files.
    ...
    \item Cedric returned and I talked with him about the MCMC test. For now it works, but with caveats which can be found commented in Rib\sep Model\sep Framework\sep/\sep tests\sep /\sep testthat\sep /\sep test\sep MCMC\sep ROC\sep .\sep R.
\end{itemize}
...
\begin{itemize}
    ...
    \item Also started replying to Dr. Gilchrist's footnotes written on June 30.
\end{itemize}
