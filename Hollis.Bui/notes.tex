...
\begin{itemize}
    ...
    Mainly all\sep Unique\sep \_kl\sep \_reduced.R, all\sep Unique\sep \_sim\sep Mod.R
...
%It seems that the function call \enquote{parameter\sep \$get\sep Codon\sep Specific\sep Variance\sep (mixture, samples*0.1, codons[i], 1, TRUE, T)} is not working.
