...
\begin{itemize}
    ...
    \item Given Alpha, Lambda Prime, Phi, and a fasta file (presumably), use simulate\sep Genome to creat a file that writes this simulated data to a .csv file or whatever.
