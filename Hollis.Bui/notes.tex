...
\begin{itemize}
    ...
    \end{figure}
    \item The bottom axis, not shown (see the file RFPJeremyConfidenceIntervalsForAlphaAndLambdaPrime.pdf, figure on the final page, under the folder 7\sep -\sep 27\sep -\sep 16\sep -\sep Jeremy\sep Correlation under the folder runLogs) is True Values.
